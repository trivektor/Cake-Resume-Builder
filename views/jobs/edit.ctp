<?=$this->set('title_for_layout', 'Edit Job Post')?>
...
<div class="box">
	<div id="job_post_form">
		...
		<h2><?=$this->Html->image('main/editJobPostHeader.png')?></h2>
		...
		<div class="form_row">
			...
			<?= $this->Form->input('job_experience_level', array('options' => $job_experience_levels, 'label' => false, 'div' => false)) ?>
		</div>
		<div class="form_row">
		...
		<div class="form_row">
			<?= $this->Form->input('salary_low_end', array('options' => $salary_ranges)) ?>
		</div>
		<div class="form_row">
			<?= $this->Form->input('salary_high_end', array('options' => $salary_ranges)) ?>
		</div>
		<div class="form_row">
		...
		<div class="form_row">
			<?= $this->Form->input('keywords', array('class' => 'markitup')) ?>
			<div class="clearfloat"></div>
		</div>
		<div class="form_row">
		...
		<div class="form_row">
			<?= $this->Form->input('company_slug', array('id' => 'textbox slug_company_name', 'class' => 'textbox')) ?>
		</div>
		<div class="form_row">
		...
		<input type="image" src="/img/resume/updateJobBtn.png" alt="Update Job" />
